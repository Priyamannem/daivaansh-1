...
import venture1Cover from "@/assets/mahadev-orr-enclave-new.jpg";
import venture2Cover from "@/assets/green-rich-homes-new.jpg";
...
const ventureData = {
    "1": {
        ...
        brochure: "/legal/mahadev-plot-brochure.pdf",
        projectHighlights: [
    ...
    "2": {
        ...
        brochure: "/legal/green-rich-homes-brochure.pdf",
        projectHighlights: [
    ...
    "3": {
        ...
        brochure: "/legal/elegant-square-brochure.pdf",
        projectHighlights: [
            "HMDA Approved Layout",
    ...
    "5": {
        ...
        images: [],
        brochure: "/legal/mahateja-hill-view-brochure.pdf",
        projectHighlights: [
